#ifndef LARLITE_COVERAGEMC_CXX
#define LARLITE_COVERAGEMC_CXX

#include "CoverageMC.h"
...
namespace larlite {
  ...
  bool CoverageMC::analyze(storage_manager* storage) {
  ...
  std::pair<double,double> CoverageMC::R(const double& comW, const double& comT) {
