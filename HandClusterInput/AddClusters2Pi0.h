/**
 * \file AddClusters2Pi0.h
 *
 * \ingroup HandClusterInput
 * 
 * \brief Class def header for a class AddClusters2Pi0
 *
 * @author david
 */
...
#ifndef LARLITE_ADDCLUSTERS2PI0_H
#define LARLITE_ADDCLUSTERS2PI0_H

#include "Analysis/ana_base.h"

namespace larlite {
  /**
     \class AddClusters2Pi0
     User custom analysis class made by SHELL_USER_NAME
   */
  class AddClusters2Pi0 : public ana_base{
  
  public:

    /// Default constructor
    AddClusters2Pi0(){ _name="AddClusters2Pi0"; _fout=0;}

    /// Default destructor
    virtual ~AddClusters2Pi0(){}

    /** IMPLEMENT in AddClusters2Pi0.cc!
    ...
    */
	...
	_vtx_hits[ evtinfo ] = std::vector<int>();
      ...
      if ((shr < 5) && (shr>0)) { _hit_idx_v[evtinfo].push_back( std::make_pair(shr-1,hitidx) ); }
