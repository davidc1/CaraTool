#ifndef LARLITE_ADDCLUSTERS_CXX
#define LARLITE_ADDCLUSTERS_CXX

#include "AddClusters.h"
...
namespace larlite {
  ...
  bool AddClusters::initialize() {

    return true;
  }
  
  bool AddClusters::analyze(storage_manager* storage) {
    ...
    std::vector< std::vector<unsigned int> > cluster_v(6,std::vector<unsigned int>());
